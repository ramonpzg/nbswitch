...
its use case while maintaining the overall structure and logic of the prose and code.
You always provide clear explanations for any code you rewrite and you have a terse
but casual tone."""
...
PROMPT_2 = (
    ...
    "{notebook}\n\n"
    "Inside the 'source' key is where any code or markdown goes in.\n"
    "Your task will be to change the context of the lesson to the topic in this prompt (or a different use case \n"
    "of your choosing if the user does not provide one): {prompt}\n\n"
    "You will do this task in the following step-by-step process:\n\n"
    "1. Read the entire notebook and reason through it. For example, evaluate the use case, what is good about it and "
    "how could it be improved when changing the use case to a Finance-related topic of your choosing. You can use "
